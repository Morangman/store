<template>
    <div>
        <section class="phone-container container-fliud">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 hidden-opacity">
                            <div class="phone-container-title hidden-opacity">
                                ...
                                <br>
                        <span>
                          <a>{{ product.title }} {{ selectedColors[product.id] ? selectedColors[product.id].color_name : '' }}</a>
                        </span>
                            </div>
                        </div>
                    </div>
        ...
        <h1 v-if="recommended.length">Сопутствующие товары</h1>
        <div v-for="(recommend, key) in recommended" :key="`recommended_${key}`">
        <section class="phone-container container-fliud">
            <div class="mti_template">
                <p>{{ recommend.general_info }}</p>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-5 hidden-opacity"></div>
                    <div class="col-md-7 hidden-opacity">
                        <div class="phone-container-title hidden-opacity">
                            ...
                            <br>
                            <span>
                          <a>{{ recommend.title }} {{ selectedColors[recommend.id] ? selectedColors[recommend.id].color_name : '' }}</a>
                        </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item active">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-5 phone-preview">
                                    <img class="hidden-opacity" :src="selectedColors[recommend.id] ? selectedColors[recommend.id].image : recommend.image">
                                    <div class="clear"></div>
                                    <div class="clear"></div>
                                    <div class="preview-buttons">
                                        <button class="characteristics fancybox-2 hidden-xs" href="#characteristics-popup">Характеристики</button>
                                ...
                                <div class="col-md-7 hidden-opacity">
                                    <form class="variations_form cart" enctype="multipart/form-data" method="post">
                                        <div class="check-color">Выберите цвет:</div>
                                        <div class="row col colorflex">
                                            <div class="col-xs-2 col-md-2 col col-md-2 col-md-offset-0 col" v-for="(color, i) in recommend.variations" :key="`recommended-variation_${i}`">
                                                <div class="color-div" v-on:click="selectColor(recommend, color)">
                                                    <div class="color-img color-img-white" :style="'background: ' + color.color"></div>
                                                    <p>{{ color.color_name }}</p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="woocommerce-variation-price">
                                          <span class="price">
                                            <del>
                                              <!-- цена x -->
                                              <span class="amount main_p">
                                                {{ selectedColors[recommend.id] ? selectedColors[recommend.id].old_price : recommend.old_price }} грн.</span>
                                            </del>
                                            <ins>
                                              <span class="amount sale_p">{{ selectedColors[recommend.id] ? selectedColors[recommend.id].price : recommend.price }} грн.</span>
                                            </ins>
                                          </span>
                                        </div>
                                        <div class="woocommerce-variation-availability"></div>
