...
$(document).ready(function () {
  ...
  $("#buy-in-click-popup form").submit(function (e) {
    ...
    if (flagChekout) return false; //Отправка данных на сервер
    ...
    data.append('ip_model', $('#ip_model').text()); //отправка через аякс
    // 	$.ajax({
    // 		url: 'send.php',
    // 		data: data,
    // 		processData: false,
